...
console.log(parent2.foo, '1111111111111111')
parent2.foo = "xxx"
...
const type1 = new UniversalType<string>()
const type2 = new UniversalType<number>()
type1.add('2').add('3')
type2.add(4).add(5).delete(4)
